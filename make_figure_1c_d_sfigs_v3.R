...
#
tab = read.table("figures/inputs_for_fig1/input_file_for_k562_multi_moi1_panel.txt",header = T,sep = '\t')

tab2 = tab[tab$experiment != "moi5_multi_moi" & tab$experiment != "moi3_multi_moi",]

exp_order2 = c("moi1_combined_reps","moi3_multi_moi","moi5_multi_moi", "moi6_multi_moi", "moi9_multi_moi", "moi14_multi_moi","moi20_hsg")

p_v2 = ggplot(tab2,aes(x = factor(experiment_use,levels = exp_order2), y = as.numeric(paste0(scaled_to_mean_exp_moi1))*-100,fill = factor(experiment_use,levels = exp_order2)))+
  geom_boxplot()+
  ...
  labs(fill = "MOI",y = "% Effect Size Normalized to Mean MOI 1", x = "")+
  ylim(-175,0)

png("figures/fig1_d_k562_multi_moi_use_perc_scale.png")
print(p_v2)
dev.off()

pdf("figures/fig1_d_k562_multi_moi_use_perc_scale.pdf")
print(p_v2)
dev.off()
...
p_v3 = ggplot(wtc11_tab,aes(x = variable, y = as.numeric(paste0(normalized_to_moi1))*-100,fill = variable))+
  geom_boxplot()+
...
png("figures/Fig_SX_WTC11_multi_moi_wtc11_multi_moi_use_perc_scale.png")
print(p_v3)
dev.off()

pdf("figures/Fig_SX_WTC11_multi_moi_wtc11_multi_moi_usewtc11_multi_moi_use_perc_scale.pdf")
print(p_v3)
dev.off()